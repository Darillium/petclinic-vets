...
import io.darillium.samples.petclinic.vets.rest.SpecialtyRestController;
...
public class SpecialtyRestControllerTests {
    ...
    public void testGetSpecialtySuccess() throws Exception {
    	given(this.clinicVetsService.findSpecialtyById(1)).willReturn(specialties.get(0));
    ...
    public void testGetSpecialtyNotFound() throws Exception {
    	given(this.clinicVetsService.findSpecialtyById(-1)).willReturn(null);
        this.mockMvc.perform(get("/api/specialties/-1")
    ...
    public void testGetAllSpecialtysSuccess() throws Exception {
    	...
    	given(this.clinicVetsService.findAllSpecialties()).willReturn(specialties);
    ...
    public void testUpdateSpecialtySuccess() throws Exception {
    	given(this.clinicVetsService.findSpecialtyById(2)).willReturn(specialties.get(1));
